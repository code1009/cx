...
//StartOffset(h) : 00000000, EndOffset(h) : 0000022D, 길이(h) : 0000022E

unsigned char png_1[558] = {
...
//StartOffset(h) : 00000000, EndOffset(h) : 0000022C, 길이(h) : 0000022D * /
unsigned char png_2[557] = {
	0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A, 0x00, 0x00, 0x00, 0x0D,
	0x49, 0x48, 0x44, 0x52, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x10,
	0x08, 0x06, 0x00, 0x00, 0x00, 0x1F, 0xF3, 0xFF, 0x61, 0x00, 0x00, 0x01,
	0x84, 0x69, 0x43, 0x43, 0x50, 0x49, 0x43, 0x43, 0x20, 0x70, 0x72, 0x6F,
	...
	_Window(window)
{
	...
	groupItem = makeGroupItem(makeID(), L"GroupItem1", L"icon1");
	addItem(nullptr, groupItem);

	subItem = makeSubItem(makeID(), L"SubItem1", L"icon1");
	addItem(nullptr, subItem);

	subItem = makeSubItem(makeID(), L"SubItem2", L"icon2");
	addItem(nullptr, subItem);

	subItem = makeSubItem(makeID(), L"SubItem3", L"icon1");
	addItem(nullptr, subItem);

	subItem = makeSubItem(makeID(), L"SubItem4", L"icon1");
	addItem(nullptr, subItem);
	...
	subGroupItem = makeGroupItem(makeID(), L"GroupItem1", L"icon1");
	addItem(groupItem, subGroupItem);
	subItem = makeSubItem(makeID(), L"SubItem6", L"icon2");
	addItem(subGroupItem, subItem);
	subItem = makeSubItem(makeID(), L"SubItem7", L"icon2");
	addItem(subGroupItem, subItem);
	subItem = makeSubItem(makeID(), L"SubItem8", L"icon2");
	addItem(subGroupItem, subItem);


	_BitmapList.addBitmap(L"icon1", cx::gw::makeBitmap(png_1, sizeof(png_1)));
	_BitmapList.addBitmap(L"icon2", cx::gw::makeBitmap(png_2, sizeof(png_2)));
